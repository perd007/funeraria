...
<body>
<table width="544" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" class="bordes">
  <tr>
    <th colspan="6" bgcolor="#CCCCCC" scope="col">Consulta General de Contratos </th>
  </tr>
  <tr>
    <td width="138" bgcolor="#CCCCCC"><div align="center"><strong>Cliente</strong></div></td>
    <td width="106" bgcolor="#CCCCCC"><div align="center"><strong>N&deg; de Contrato </strong></div></td>
    <td width="59" bgcolor="#CCCCCC"><div align="center"><strong>Plan</strong></div></td>
    <td width="70" bgcolor="#CCCCCC"><div align="center"><strong>Modificar</strong></div></td>
    <td width="54" bgcolor="#CCCCCC"><div align="center"><strong>Eliminar</strong></div></td>
    <td width="77" bgcolor="#CCCCCC"><div align="center"><strong>Detalles</strong></div></td>
  </tr>
  <?php do { ?>
    <tr>
      ...
      <td bgcolor="#f2f0f0"><div align="center"><? echo "<a href='modificar_contrato.php?id=$row_contratos[id]'>IR</a>" ?></div></td>
      <td bgcolor="#f2f0f0"><div align="center"><? echo "<a onClick='return validar()'href='eliminar_contrato.php?id=$row_contratos[id]'>IR</a>" ?></div></td>
      <td bgcolor="#f2f0f0"><div align="center"><? echo "<a href='detalle_contrato.php?id=$row_contratos[id]'>IR</a>" ?></div></td>
    </tr>
