...
if($totalRows_contratos==0){
	echo "<script type=\"text/javascript\">alert ('No existe un contrato con este numero'); location.href='consulta_contrato_numero.php' </script>";
    exit;
	}
...
<table width="681" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" class="bordes">
  ...
  <tr>
    <td width="325" bgcolor="#CCCCCC"><div align="center"><strong>Cliente</strong></div></td>
  ...
  <?php do { ?>
    <tr>
      ...
      <td bgcolor="#f2f0f0"><div align="center"><? echo "<a href='modificar_contrato_numero.php?id=$row_contratos[id]'>IR</a>" ?></div></td>
      <td bgcolor="#f2f0f0"><div align="center"><? echo "<a onClick='return validar()' href='eliminar_contrato_numero.php?id=$row_contratos[id]'>IR</a>" ?></div></td>
      <td bgcolor="#f2f0f0"><div align="center"><? echo "<a href='detalle_contrato_numero.php?id=$row_contratos[id]'>IR</a>" ?></div></td>
    </tr>
