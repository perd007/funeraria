...
<title>Generar Contrato por Cedula</title>
<style type="text/css">
<!--
.Estilo1 {
	font-size: 30px;
  ...
  <tr>
    <td colspan="4"><table width="568" border="0" align="center">
        <tr>
          ...
          <td width="96"><div align="center"><?php echo $row_contratos['dia']; ?></div></td>
          <td width="99"><div align="center"><?php echo $row_contratos['mes']; ?></div></td>
