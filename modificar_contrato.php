...
if($totalRows_contra>=1){
  ...
  $Result1 = mysql_query($updateSQL, $funeraria) or die(mysql_error());
      ...
      if($Result1){
  echo "<script type=\"text/javascript\">alert ('Datos Modificados');  location.href='consulta_contratos.php' </script>";
  }else{
  echo "<script type=\"text/javascript\">alert ('Ocurrio un Error');  location.href='consulta_contratos.php' </script>";
  exit;
  }
}
