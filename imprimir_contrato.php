...
function abrir(){
var ruta='imprirmir_contrato_cedula.php?cedula=' + document.form2.cedula.value;

open(ruta,'','top=300','left=300','width=300','height=300');
}			
</script>
<body>
<form id="form1" name="form2" method="post" onsubmit="return validar()" action="javascript:abrir()" >
  <p>&nbsp;</p>
  <table width="259" border="0" align="center" cellpadding="1" cellspacing="2" class="bordes">
    <tr>
      <th colspan="2" bgcolor="#999999" scope="col">Imprimir Contrato por Cedula </th>
    </tr>
    <tr>
