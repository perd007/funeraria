...
$resultadoV=mysql_query($sqlV, $funeraria) or die(mysql_error());
...
$usuario = mysql_query($query_usuario, $funeraria) or die(mysql_error());
...
<form method="post" name="form1" onSubmit="return validar()" action="<?php echo $editFormAction; ?>">
  ...
  <table align="center" class="bordes">
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap bgcolor="#999999"><div align="center"><strong>Modificacion de Usuarios </strong></div></td>
    </tr>
    <tr valign="baseline">
      <td width="253" align="right" nowrap><div align="right"><strong><span class="Estilo5">Usuario:</span></strong></div></td>
      <td width="245"><input name="login" type="text" class="Estilo5" id="login" value="<?php echo $row_usuarios['usuario']; ?>" size="32" maxlength="10"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap align="right"><strong>Apellido:</strong></td>
    ...
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap bgcolor="#999999"><div align="center" class="Estilo1">Permisos</div></td>
    </tr>
    <tr valign="baseline">
	  ...
	  <input name="modificar" type="checkbox" class="Estilo3" id="modificar" value="modificaciones"  <?php if($row_usuarios['modificar']==1) echo $seleccion; ?> />
	    </span> Modificaciones<span class="Estilo5">
...
<input name="administrar" type="checkbox" <?php if($row_usuarios['administrar']==1) echo $seleccion; ?> id="administrar" value="administar" />
    ...
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap bgcolor="#999999"><div align="center" class="Estilo5">
