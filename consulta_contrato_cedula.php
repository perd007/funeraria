...
<body>
<form id="form1" name="form2" method="get" onsubmit="return validar()" action="consulta_contrato_cedula2.php" target="marco">
  <p>&nbsp;</p>
  <table width="259" border="0" align="center" cellpadding="1" cellspacing="2" class="bordes">
    <tr>
      <th colspan="2" bgcolor="#999999" scope="col">Consulta de  Contrato por Cedula </th>
    </tr>
    <tr>
