...
<body>
<form id="form1" name="form2" method="post" onsubmit="return validar()" action="generar_carnet.php" target="_blank" >
  <p>&nbsp;</p>
  <table width="259" border="0" align="center" cellpadding="1" cellspacing="2" class="bordes">
    <tr>
      <th colspan="2" bgcolor="#999999" scope="col">Generar Carnet </th>
    </tr>
    <tr>
